...
export interface ApiCourseItemCourseItem extends Schema.SingleType {
...
export interface ApiCourseListCourseList extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.RichText;
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    introduction: Attribute.Component<'topic.topic'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiDetailDetail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    name: Attribute.Component<'text.text'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiInfosterInfoster extends Schema.CollectionType {
  ...
  info: {
    singularName: 'infoster';
    pluralName: 'infosters';
    displayName: 'infoster';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    nam: Attribute.Component<'name.infor'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiVideCourseVideCourse extends Schema.CollectionType {
  collectionName: 'vide_courses';
  info: {
    singularName: 'vide-course';
    pluralName: 'vide-courses';
    displayName: 'VideCourse';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVideoTopicVideoTopic extends Schema.SingleType {
  collectionName: 'video_topics';
  info: {
    singularName: 'video-topic';
    pluralName: 'video-topics';
